...
<div>
    ...
    <form method='POST'
          action='?etapa_32&consultainicial_Canciones&anio_<%= session.getAttribute("anhio")%>album_<%= session.getAttribute("album2")%>'>
        ...
        <p><input type='submit' value='Enviar'>
            ...
            <br><input type='submit' onclick='form.etapa.value=122' value='Atrás'>
